...
\begin{abstract}
Many comets, asteroids, and interstellar objects such as 1I/'Oumuamua move in escape trajectories and experience large but transient variation in temperatures while passing a stellar system. These temperatures are averaged by numeric integration over a desired time period. Here we derive analytic solutions for the average equilibrium temperature of any planetary body in escape trajectories, including hyperbolic, parabolic, and linear paths. Our solutions are used to explore the net thermal effect on these bodies as a function of eccentricity and travel time. We found that 1I/'Oumuamua experienced a mild change in temperature compared to comets in similar trajectories and this probably contributed to the inactivity of any ices in its surface.
...
\centering
\caption{Properties of circular, elliptic, parabolic, and hyperbolic trajectories.}
\begin{tabular}{ l c c c c c }
 \hline
 \hline
 Element & Circular & Elliptic & Parabolic &
 ...
 Position, $r(E, D,$ or $H)$ & $r=a$ & $r=a(1-e\cos{E})$ & $r=r_p(1+D^2)$ & $r=r_p\frac{e\cosh{H}-1}{e-1}$  & $-$ \\ 
  
 Periastron, $r_p$ & $r_p=a$ & $r_p=a(1-e)$ & $r_p=r_p$ & $r_p=r_p$ & $r_p=r_p$ \\
 
 Apastron, $r_a$ & $r_a=a$ & $r_a=a(1+e)$ & $r_a=\infty$ & $r_a=\infty$ & $r_a=\infty$ \\
 
 True Anomaly, $f$ & $f=E$ & $\tan{\frac{f}{2}}=\sqrt{\frac{e+1}{e-1}}\tan{\frac{E}{2}}$ & $\tan{\frac{f}{2}}=D$ & $\tan{\frac{f}{2}}=\sqrt{\frac{e+1}{e-1}}\tanh{\frac{H}{2}}$ & $-$ \\
 
 Conic Anomaly, $E, D, or H$ & $E=f$ & $\cos{E}=\frac{e+\cos{f}}{1+e\cos{f}}$ & $D=\tan{\frac{f}{2}}$ & $\tanh{\frac{H}{2}}=\sqrt{\frac{e-1}{e+1}}\tan{\frac{f}{2}}$ & $-$ \\
 
 Mean Anomaly, $M$ & $M=E$ & $M=E-e\sin{E}$ & $M=D+\frac{1}{3}D^3$ & $M=e\sinh{H}-H$ & $-$ \\
 
 Time from Periastron & $t=M\sqrt{\frac{a^3}{\mu}} + t_o$ & $t=M\sqrt{\frac{a^3}{\mu}} + t_o$ & $t=M\sqrt{\frac{2r_p^3}{\mu}} + t_o$ & $t=M\sqrt{\frac{r_p^3}{\mu(e-1)^3}} + t_o$ & $-$ \\

 Period, $T$ & $T=2\pi\sqrt{\frac{a^3}{\mu}}$ & $T=2\pi\sqrt{\frac{a^3}{\mu}}$ & $T=2M_o\sqrt{\frac{2r_p^3}{\mu}}$ & $T=2M_o\sqrt{\frac{r_p^3}{\mu(e-1)^3}}$ & $-$ \\
 
 Eccentricity Range & $e=0$ & $0<e<1$ & $e=1$ & $1<e<\infty$ & $e=\infty$ \\
 
 True Anomaly Range & $0\leq f \leq 2\pi$ & $0\leq f \leq 2\pi$ & $-$ & $-\cos{(-\frac{1}{e})} < f < +\cos{(-\frac{1}{e})}$ & $-\frac{\pi}{2} < f < +\frac{\pi}{2}$ \\

 Conic Anomaly Range & $0\leq E \leq 2\pi$ & $0\leq E \leq 2\pi$ & $-\infty < D < +\infty$ & $-\infty< H < +\infty$ & $-$ \\
 
 Mean Anomaly Range & $0\leq M \leq T$ & $0\leq M \leq T$ & $-\infty< M < +\infty$ & $-\infty < M < +\infty$ & $-\infty < M < +\infty$ \\
...
\begin{tabular}{ l c c c c | c c c }
 ...
 \hline
 1P/Halley & 17.834145 & 0.96714291 & \fix{0.04} & 26.174  & 0.0123 & 59.7 \\  
...
\label{tab:escape}
	\begin{tablenotes}
	\small
\item[a]{Object elements from the NASA Solar System Dynamic website \href{https://ssd.jpl.nasa.gov/?sb$\_$elem}{https://ssd.jpl.nasa.gov/?sb$\_$elem} and albedos from \fix{X}.}
